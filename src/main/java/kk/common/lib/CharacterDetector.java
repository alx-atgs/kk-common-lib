...
/**
 * Character detector implementation based on Google's <a href=
 * "http://juniversalchardet.googlecode.com/files/juniversalchardet-1.0.jar">juniversalchardet</a>
 * library.
 */
public class CharacterDetector {
	...
	public static final CharacterDetector getInstance() {
		if (instance == null)
			instance = new CharacterDetector();
		return instance;
	}
	 ...
	 * 
	 * @param stream
	 * @return name of the detected character encoding, or <tt>null</tt> if encoding
